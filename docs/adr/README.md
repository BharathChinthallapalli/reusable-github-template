...
| [0009: Native tooling and review evidence](0009-native-tooling-and-review-evidence.md) | Accepted | Pinned uv/ast-grep setup, independent repair review and current validation |
| [0010: Worktree hook bootstrap](0010-worktree-hook-bootstrap.md) | Accepted | Session-start preparation of isolated validation tools before fail-closed tool checks |
...
Agents must read the relevant Accepted ADRs before relying on a design. An
[Agent Design Document](../add/README.md) links decisions to an implementation's
purpose, permissions, behavior, exact file scope and verification. An ADD does
not supersede an ADR; resolve a conflicting durable choice through a new ADR.
